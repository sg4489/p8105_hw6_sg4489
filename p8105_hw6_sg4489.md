...
*tmin* and *tmax* (via $\log(\beta_0 \cdot \beta_1)$) is robust and
unlikely to vary much with different data samples.
...
![](p8105_hw6_sg4489_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](p8105_hw6_sg4489_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](p8105_hw6_sg4489_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
